...
urlpatterns = [
    ...
    path('<code>/slot', SlotCreateView.as_view(), name='slot_create'),
    path('<code>/slot/<int:pk>', SlotRetrieveUpdateDestroyView.as_view(), name='slot'),
    path('only', AssetSummaryListView.as_view()),
